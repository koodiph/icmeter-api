...
use ICMeter\API\PHP\Common\RestErrorCode;

/**
 * OAuth2.0 ICMeter client-side implementation.
 */
class Client
{
    /**
    ...
    const BACKEND_BASE_URI         = 'http://app.ic-meter.com/icm/';
    const BACKEND_SERVICES_URI     = 'http://app.ic-meter.com/icm/api';
    const BACKEND_ACCESS_TOKEN_URI = 'https://app.ic-meter.com/icm/oauth/token';
    const BACKEND_AUTHORIZE_URI    = 'https://app.ic-meter.com/icm/oauth/authorize';
     ...
     *   - object_cb     : (optional) An object for which func_cb method will be applied if object_cb exists
    ...
    public static $CURL_OPTS = array(
        ...
        CURLOPT_HEADER         => TRUE,
        CURLOPT_TIMEOUT        => 60,
        CURLOPT_USERAGENT      => 'icmeterclient',
     ...
     *
     * @return A valid array containing at least an access_token as an index
     * @throws A ClientException if unable to retrieve an access_token
     */
    ...
    /**
     * Get url to redirect to oauth2.0 icmeter authorize endpoint
     * This is the url where app server needing icmeter access need to route their user (via redirect)
     *
     * @param scope scope used here
     * @param state state returned in redirect_uri
     */
     ...
     *
     * @return A valid OAuth2.0 JSON decoded access token in associative array
     * @throws A ClientException if unable to retrieve an access_token
     */
     ...
     *
     * @param $path   The target path, relative to base_path/service_uri
     * @param $method (optional) The HTTP method (default 'GET').
     * @param $params (optional The GET/POST parameters.
     *
     ...
     * @param $params (optional The GET/POST parameters.
     *
     * @return The JSON decoded body response object.
     *
    ...
    /**
     * Make a REST call to a ICMeter server that do not need access_token
     *
     * @param $path   The target path, relative to base_path/service_uri or an absolute URI.
     * @param $method (optional) The HTTP method (default 'GET').
     * @param $params (optional The GET/POST parameters.
